...
@section('admin_content')
	<div class="row">
		...
		<div class="col-md-12">
			<h1 style="color:#348EFE;">Edit Member Profile</h1>
		</div>
		<div class="col-md-12">
			<div class="portlet box blue" id="form_wizard_1">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-gift"></i> Edit Member Profile
					</div>
				...
				<div class="portlet-body form">
					...
					<form action="{{ url('/admin/genealogy/edit') }}" class="form-horizontal" id="submit_form" method="POST"> 
					 {{ csrf_field() }}
								...
								<div class="tab-content">
									...
									<div class="tab-pane active" id="tab1">
										...
										<div class="form-group">
											...
											* </span>
											...
											<div class="col-md-4">
												<input type="text" class="form-control" name="sponsor" value="{{$user->username}}" readonly="" />
									...
									<div class="tab-pane" id="tab2">
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<select name="country" id="country_list" class="form-control" value="{{$user->country}}">
													<option value=""></option>
										...
										<div class="form-group">
											...
											* </span>
											...
											<div class="col-md-4">
												<input type="number" class="form-control" name="zipcode" value="{{$user->zip_code}}"/>
												<span class="help-block">
												Edit Zip Code </span>
											</div>
										</div>
										<div class="form-group">
											...
											* </span>
											...
											<div class="col-md-4">
												<input type="text" class="form-control" name="phone" value="{{$user->mobile_number}}"/>
												<span class="help-block">
